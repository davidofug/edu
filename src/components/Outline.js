...
function Outline({ id }) {
  ...
  const fetchOutline = async () => {
    const response = await fetch(
      "https://theablestate.github.io/edu/fullstack-cohort-2-outline.json"
    );
    ...
    <div className="container mx-auto p-4  text-sm">
      <div className="align-center leading-6 mb-4">
        ...
        <h1 className="text-md">
          <b>Full Stack Web Developer - Cohort 2 (March - October, 2022)</b>
        </h1>
        <p>
          We welcome you to the second cohort of Full Stack Web Development at
          Ablestate Creatives Limited.
        </p>
        <p>
          <b>Notice</b>
          <br />
          1. The Internship opportunity comes to best performers in terms of
          attendance, quiz submission, participation in review questionaires and
          project completion rates. <br /> Interested individuals will be able
          to apply.
          <br />
          The internship is a maximum of 2 months and not paid.
        </p>
        <p>
          2. Apprenticiship is also optional and the duration varies from 3 to 6
          months. <br /> During the Apprenticiship you get to work on systems
          that are used in the industry.
        </p>
        <p>
          While practicing as an Apprentice you get paid on per project basis.
          Apprenticiship are only available to those who have completed the Full
          Stack Web Development course with us. Interested individuals will be
          able to apply.
        </p>
            ...
            {outline.map(
              (
                ...
                <tr key={index.toString()}>
                  ...
                  <td className="border-collapse border border-slate-400 p-2 align-top">
                    <p>
                      {facilitator} - <b>Main</b>
                    </p>
                    {coFacilitators && (
                      <p>
                        <b>Co-facilitator(s)</b>
                      </p>
                    )}
                    {coFacilitators &&
                      coFacilitators
